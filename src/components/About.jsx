        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="text-xl opacity-90">
              Vatia High School - একটি আদর্শ শিক্ষা প্রতিষ্ঠান যেখানে ঐতিহ্য ও আধুনিকতার মেলবন্ধন
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Vatia High School ২০১০ সালে প্রতিষ্ঠিত একটি আধুনিক শিক্ষা প্রতিষ্ঠান। 
                আমাদের প্রতিষ্ঠানে ৬ষ্ঠ থেকে দ্বাদশ শ্রেণী পর্যন্ত শিক্ষা কার্যক্রম পরিচালিত হয়। 
            ...
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <CardContent className="text-center">
                ...
                <blockquote className="text-lg text-muted-foreground leading-relaxed italic">
                  "Vatia High School-এ আমাদের লক্ষ্য শুধু একাডেমিক শিক্ষা প্রদান নয়, 
